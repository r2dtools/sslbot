...
func (m *DefaultHostManager) Enable(configFilePath, enabledConfigRootPath string) (string, error) {
...
func (m *DefaultHostManager) Disable(enabledConfigFilePath string) error {
	var err error
